...
//	private Collection<DataExtractor> extractors;
	...
	public String getName() {
		return Translator.swap("JFCLineChart.name");
	}
	...
	public String getDescription() {
		return Translator.swap("JFCLineChart.description");
	}
	...
	/**
	 * Update strategy for JFCLineChart and its subclasses. This method is used to
	...
	protected JComponent createView() {
		try {
			...
			if (dsc.isXsWithLabels() || !dsc.isXYSeriesCollection()) {
				...
				// fc-23.12.2020
				return new MessagePanel(getName() + " " + Translator.swap("JFCLineChart.canNotShowTheseData"),
						(MouseListener) this);
...
//						+" "+Translator.swap ("JFCLineChart.canNotShowTheseData"), (MouseListener) this);
			...
			// fc-23.12.2020
			return new MessagePanel(getName() + " " + Translator.swap("JFCLineChart.canNotShowTheseDataSeeLog"),
					(MouseListener) this);
//			Log.println(Log.ERROR, "JFCLineChart.createView ()", "Exception", e);
...
//		BarRenderer.setDefaultShadowsVisible(false);  // removes the bars shadows
		...
		JFreeChart chart = ChartFactory.createXYLineChart(dsc.getTitle(), // chart title -> leave blank, written in
																			// frame title bar
