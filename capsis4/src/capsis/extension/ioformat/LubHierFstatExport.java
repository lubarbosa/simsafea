...
/**	
 * Genetic export: exports allele values per locus for a list of selected trees.
 * 
 * @author F. de Coligny - December 2003
 */
public class LubHierFstatExport extends StandRecordSet implements OFormat {
...
//		return true;
	...
	public String getName () {
		return Translator.swap ("LubHierFstatExport.name");
	}
	...
	public String getDescription () {
		return Translator.swap ("LubHierFstatExport.description");
	}
