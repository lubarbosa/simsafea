...
public class DETimeAMV extends DETimeG {
	...
	public DETimeAMV(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeAMV.c ()", "Exception during construction : ", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeAMV.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeAMV.description");
	}
