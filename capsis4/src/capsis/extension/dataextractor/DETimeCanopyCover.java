...
public class DETimeCanopyCover extends DETimeG {
	...
	public boolean matchWith(Object referent) {
		try {
			...
			if (!(mp instanceof CanopyCoverProvider)) {
				return false;
			}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeCanopyCover.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeCanopyCover.description");
	}
	...
	public boolean doExtraction() {
		...
		try {
			...
			for (Iterator i = steps.iterator(); i.hasNext();) {
				...
				double CanopyCover = ((CanopyCoverProvider) methodProvider).getCanopyCover(stand, trees); // (canopy
																											// cover
																											// (%))
