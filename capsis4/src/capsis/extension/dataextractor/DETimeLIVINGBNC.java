...
public class DETimeLIVINGBNC extends DETimeG {
	...
	public DETimeLIVINGBNC(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeLIVINGBNC.c ()", "Exception during construction", e);
		}
	}
	...
	public boolean matchWith(Object referent) {
		try {
			...
			if (!(mp instanceof LivingBranchNitrogenContentProvider)) {
				return false;
			}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeLIVINGBNC.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeLIVINGBNC.description");
	}
		...
		try {
			...
			do {
				...
				double livingBNC = ((LivingBranchNitrogenContentProvider) methodProvider)
						.getLivingBranchNitrogenContent(stand, trees); // (NC :
																		// t)
