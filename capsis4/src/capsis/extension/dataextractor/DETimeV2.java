...
/**
 * Volume over Time(/age) or over Hdom. With possibility to view annual
 * increment.
 * 
...
public class DETimeV2 extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeV2(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeV2.c ()", "Exception during construction", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeV2.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeV2.description");
	}
	...
	public List<String> getAxesNames() {
		 ...
		 * ("DETimeV2.yLabel")+" (ha)"); } else { v.add (Translator.swap
		 * ("DETimeV2.yLabel")); }
		 */
		String yLab;
