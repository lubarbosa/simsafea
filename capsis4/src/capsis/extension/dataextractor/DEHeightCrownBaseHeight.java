...
public class DEHeightCrownBaseHeight extends DETimeG {
	...
	/**
	 * Constructor 2, uses the extension starter.
	 */
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEHeightCrownBaseHeight.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEHeightCrownBaseHeight.description");
	}
	...
	public boolean doExtraction() {
		...
		// System.out.println
		// ("DEHeightCrownBaseHeight : extraction being made");
		try {
