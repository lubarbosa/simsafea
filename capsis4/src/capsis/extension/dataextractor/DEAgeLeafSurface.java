...
/**
 * Leaf Surface Age Scatterplot (From DEDbhLeafSurface). Specific to
 * AMAPSimRequestableTree.
 * 
...
public class DEAgeLeafSurface extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEAgeLeafSurface.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEAgeLeafSurface.description");
	}
