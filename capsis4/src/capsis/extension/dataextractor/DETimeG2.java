...
/**
 * Basal area over Time(/age) or over Hdom. With possibilty to view annual
 * increment
 * 
...
public class DETimeG2 extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeG2(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeG2.c ()", "Exception during construction", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeG2.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeG2.description");
	}
	...
	public List<String> getAxesNames() {
		 ...
		 * ("DETimeG2.yLabel")+" (/ha)"); } else { v.add (Translator.swap
		 * ("DETimeG2.yLabel")); }
		 */
		String yLab;
