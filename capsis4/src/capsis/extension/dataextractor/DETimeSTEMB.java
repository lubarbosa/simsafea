 ...
 */
public class DETimeSTEMB extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeSTEMB(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeSTEMB.c ()", "Exception during construction", e);
		}
	}
	...
	public boolean matchWith(Object referent) {
		try {
			...
			if (!(mp instanceof StemBiomProvider))
				return false;
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeSTEMB.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeSTEMB.description");
	}
	...
	public boolean doExtraction() {
		...
		try {
			...
			for (Iterator i = steps.iterator(); i.hasNext();) {
				...
				double stemBiomass = ((StemBiomProvider) methodProvider).getStemWoodBiom(stand, trees) * coefHa;
