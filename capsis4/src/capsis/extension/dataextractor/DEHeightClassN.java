...
public class DEHeightClassN extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEHeightClassN.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEHeightClassN.description");
	}
	...
	public List<String> getAxesNames() {
		...
		String xl = isSet("displayClassNames") ? Translator.swap("Shared.class")
				: Translator.swap("DEHeightClassN.xLabel");
		v.add(xl);

		String yl = Translator.swap("DEHeightClassN.yLabel");
		if (isSet("perHectare"))
			yl += " (ha)";
		v.add(yl);
