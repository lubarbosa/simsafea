...
public class DETimeHgCrownBaseHeightg extends DETimeG {
	...
	public DETimeHgCrownBaseHeightg(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeHgCrownBaseHeightg.c ()", "Exception during construction", e);
		}
	}
	...
	public boolean matchWith(Object referent) {
		try {
			...
			if (!(mp instanceof CrownBaseHeightgProvider)) {
				return false;
			}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeHgCrownBaseHeightg.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeHgCrownBaseHeightg.description");
	}
	...
	public boolean doExtraction() {
		...
		try {
			...
			for (Iterator i = steps.iterator(); i.hasNext();) {
				...
				double CrownBaseHeightg = ((CrownBaseHeightgProvider) methodProvider).getCrownBaseHeightg(stand, trees);
