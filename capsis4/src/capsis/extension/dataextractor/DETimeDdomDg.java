...
public class DETimeDdomDg extends DETimeG {
	...
	public DETimeDdomDg(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeDdomDg.c ()", "Exception during construction", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeDdomDg.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeDdomDg.description");
	}
	...
	// nb-08.08.2018
	//public static final String VERSION = "1.2"; // PhD 2009-10-13 : Ddom can now
												// be hidden
	...
	public List<String> getAxesNames() {
		...
		if (!isSet("hideDdom"))
			v.add(Translator.swap("DETimeDdomDg.yLabel"));
		else
			v.add(Translator.swap("DETimeDdomDg.yLabel_"));
		return v;
	}
