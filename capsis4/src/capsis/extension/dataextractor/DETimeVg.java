...
/**
 * Vg over Time(/age) or over Hdom. With possibility to view annual increment.
 * 
...
public class DETimeVg extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeVg(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeVg.c ()", "Exception during construction", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeVg.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeVg.description");
	}
