...
public class DELogNLogMeanV extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DELogNLogMeanV.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DELogNLogMeanV.description");
	}
	...
	public boolean doExtraction() {
		...
		try {
			...
			for (Iterator i = steps.iterator(); i.hasNext();) {
				...
				double N = ((NProvider) methodProvider).getN(stand, trees); // fc
																			// -
																			// 22.8.2006
																			// -
																			// Numberable
