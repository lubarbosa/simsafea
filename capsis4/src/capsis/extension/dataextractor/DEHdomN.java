...
/**
 * Number of trees versus Hdom (from DETimeN.java)
 * 
...
public class DEHdomN extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEHdomN.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEHdomN.description");
	}
		...
		try {
			...
			for (Iterator i = steps.iterator(); i.hasNext();) {
				...
				double N = ((NProvider) methodProvider).getN(stand, trees) * coefHa; // fc
																						...
																						// is
																						// double
				double Hdom = ((HdomProvider) methodProvider).getHdom(stand, trees); // (Hdom
																						// :
																						// m)

				// (new Double (((HdomProvider) methodProvider).getHdom (stand,
				// trees)));
