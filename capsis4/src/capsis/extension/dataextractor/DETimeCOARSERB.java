 ...
 */
public class DETimeCOARSERB extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeCOARSERB(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeCOARSERB.c ()", "Exception during construction", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeCOARSERB.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeCOARSERB.description.name");
	}
	...
	public boolean doExtraction() {
		...
		try {
			...
			for (Iterator i = steps.iterator(); i.hasNext();) {
				...
				double coarseRBiomass = ((CoarseRootBiomProvider) methodProvider).getCoarseRootBiom(stand, trees)
						* coefHa;
