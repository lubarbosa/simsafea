...
/**
 * Numbers of trees per large diameter classes, based on DESpeciesClassN.
 * 
...
public class DELargeDbhClassN extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DELargeDbhClassN.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DELargeDbhClassN.description");
	}
