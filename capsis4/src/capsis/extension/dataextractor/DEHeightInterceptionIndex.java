...
public class DEHeightInterceptionIndex extends DETimeG {
	...
	public boolean matchWith(Object referent) {
		try {
			...
			Log.println(Log.ERROR, "DEHeightInterceptionIndex.matchWith ()", "Error in matchWith () (returned false)",
					e);
			return false;
		}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEHeightInterceptionIndex.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEHeightInterceptionIndex.description");
	}
	...
	public boolean doExtraction() {
		...
		// System.out.println
		// ("DEHeightInterceptionIndex : extraction being made");
