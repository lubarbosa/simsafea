...
public class DETimeG extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeG(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeG.c ()", "Exception during construction", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeG.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeG.description");
	}
	...
	public List<String> getAxesNames() {
		 ...
		 * ("DETimeG.yLabel")+" (ha)"); } else { v.add (Translator.swap
		 * ("DETimeG.yLabel")); }
		 */
		String yLab;
