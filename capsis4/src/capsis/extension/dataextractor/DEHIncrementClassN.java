...
public class DEHIncrementClassN extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEHIncrementClassN.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEHIncrementClassN.description");
	}
...
//			if (isSet("percentage")) {
			...
			// fc-29.7.2021 replaced PERCENTAGE
				...
				// fc-22.8.2006 Numberable is double
			...
			while (trees.hasNext()) {
				...
				double dH = t.getHeightIncrement() * 100; // HIncrement : from m
															// to cm because
															// class width must
															// be an integer
				if (dH < minThreshold) {
	...
	public List<String> getAxesNames() {
		...
		String xl = isSet("displayClassNames") ? Translator.swap("Shared.class")
				: Translator.swap("DEHIncrementClassN.xLabel");
		v.add(xl);

		// fc-29.7.2021 replaced PERCENTAGE
		String yl = Translator.swap("DEHIncrementClassN.yLabel");
