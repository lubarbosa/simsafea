...
public class DEDbhIncrementClassN extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEDbhIncrementClassN.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEDbhIncrementClassN.description");
	}
...
//			if (isSet("percentage")) {
			...
			while (trees.hasNext()) {
				...
				double dD = t.getDbhIncrement() * 10; // dbhIncrement : mm
														// because class width
														// must be an integer
	...
	public List<String> getAxesNames() {
		...
		String xl = isSet("displayClassNames") ? Translator.swap("Shared.class")
				: Translator.swap("DEDbhIncrementClassN.xLabel");
		v.add(xl);

		// fc-29.7.2021 replaced PERCENTAGE
		String yl = Translator.swap("DEDbhIncrementClassN.yLabel");
