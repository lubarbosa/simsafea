...
public class DEDiamDistrib extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEDiamDistrib.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEDiamDistrib.description");
	}
...
//		addConfigProperty(PaleoDataExtractor.CLASS_WIDTH); // fc-26.8.2021
