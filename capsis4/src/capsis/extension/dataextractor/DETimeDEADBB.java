 ...
 */
public class DETimeDEADBB extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeDEADBB(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeDEADBB.c ()", "Exception during construction", e);
		}
	}
	...
	public boolean matchWith(Object referent) {
		try {
			...
			if (!(mp instanceof DeadBranchBiomProvider)) {
				return false;
			}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeDEADBB.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeDEADBB.description");
	}
	...
	public boolean doExtraction() {
		...
		try {
			...
			for (Iterator i = steps.iterator(); i.hasNext();) {
				...
				double deadBBiomass = ((DeadBranchBiomProvider) methodProvider).getDeadBranchBiom(stand, trees)
						* coefHa;
