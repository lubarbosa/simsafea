 ...
 */
public class DETimeBARKB extends PaleoDataExtractor implements DFCurves {
	...
	public DETimeBARKB(GenericExtensionStarter s) {
		...
		try {
			...
			Log.println(Log.ERROR, "DETimeBARKB.c ()", "Exception during construction", e);
		}
	}
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DETimeBARKB.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DETimeBARKB.description");
	}
