...
public class DEDbhTrunkVolume extends DETimeG {
	...
	public String getName() {
		return getNamePrefix() + Translator.swap("DEDbhTrunkVolume.name");
	}
	...
	public String getDescription() {
		return Translator.swap("DEDbhTrunkVolume.description");
	}
	...
	public String getDefaultDataRendererClassName() {
		return "apsis.extension.datarenderer.drcurves.DRScatterPlot";
	}	
