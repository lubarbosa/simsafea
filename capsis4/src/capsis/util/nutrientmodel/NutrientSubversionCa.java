...
class NutrientSubversionCa extends NutrientConcentrationSubversionModel {
	...
	protected void init() {
		...
		betaReference.setValueAt(0, 0, 0.743); //a_wood
		betaReference.setValueAt(1, 0, 8.983); //a_bark
		betaReference.setValueAt(2, 0, -13.553); //b_bark
		betaReference.setValueAt(3, 0, -0.647); //c_bark
...
//		Bark concentration
		y.setValueAt(1, 0, beta.getValueAt(1, 0) + beta.getValueAt(2, 0) * Math.exp(beta.getValueAt(3, 0) * midDiameterCm));
