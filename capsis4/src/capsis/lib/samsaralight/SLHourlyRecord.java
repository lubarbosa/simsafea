...
public class SLHourlyRecord extends Record implements Serializable {
	...
	public int day; // [1,31] day of month
	 ...
	 * Constructor
	 */
	public SLHourlyRecord(String line) throws Exception {
		super(line);
	}

	public String toString() {
		return "SLHourlyRecord" + " month: " + month + " day: " + day + " hour: " + hour + " global: " + global
